...
public class MyShop implements IShop {
	...
	public void genProduct() {
		CellPhone_1 cp = new CellPhone_1("갤럭시 노트5", 1000000, "SKT");
		products[0] = cp;
		cp = new CellPhone_1("애플 아이폰7", 980000, "KT");
		products[1] = cp;
		SmartTV1 st = new SmartTV1("삼성 3D Smart TV", 5000000, "4K");
		products[2] = st;
		st = new SmartTV1("LG Smart TV", 2500000, "Full HD");
		products[3] = st;
	}
}
